function calculateSimple() {
    ...
    setTimeout(() => {
        ...
        graphicSimplePercentageTotal2.textContent = `${(num2 - resultado).toFixed(2)}`;
...
function calculateTotal() {
    ...
    document.getElementById("resulTotal").value = resulTotal.toFixed(2);
  ...
  `;
    ...
    setTimeout(() => {
        ...
        graphicSimplePercentageTotal2total.textContent = `${(resulTotal - (((num1Total * resulTotal) / 100))).toFixed(2)}`;
        graphicSimplePercentageTotalTotal.textContent = `${100 - num1Total}%`;
        graphicSimplePercentagetotal.textContent = `${((num1Total * resulTotal) / 100).toFixed(2)}`;//--------
        graphicSimplePercentageTotal2total1.textContent = `${(num1Total).toFixed(1)}%`;
        totalGraphicTotal.textContent = `Total : ${resulTotal.toFixed(2)}`;
    }, 100);
}
...
function calculateAmount() {
    ...
    document.getElementById("amountResult").value = amountResult.toFixed(2);
  ...
  `;
    ...
    graphichAmount2.textContent = `${amountResult.toFixed(2)}%`;
    graphichAmount3.textContent = `${(100 - amountResult).toFixed(2)}%`;
    graphichAmount4.textContent = `${((amountResult * amount1) / 100).toFixed(2)}`;
    graphichAmount5.textContent = `${(amount1 - amount2).toFixed(2)}`;
...
function calculateChange() {
    ...
    document.getElementById("resultChange").value = changeResult.toFixed(2);
